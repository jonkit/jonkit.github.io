...
<img src="http://jonkit.ca/cdn/photos/2018-01-19-about.png" alt="Me. That's me"><br />
...
+ Content is written and posted exclusively from [iOS](http://www.apple.com/ca/ios/) with my [iPhone](http://www.apple.com/ca/iphone/) and [iPad Pro](http://www.apple.com/ca/ipad/) using either Notes and Siri Shortcuts (with help from [Working Copy](http://workingcopyapp.com)) or via the [Micro.blog](https://micro.blog) app. 
+ Photos are taken with those two devices and occasionally my camera, an [Olympus OMD-E10](https://www.dpreview.com/reviews/olympus-om-d-e-m10), or a pair of [Snap Spectacles](http://spectacles.com). Edits are made using [VSCO](https://vsco.co/store/app).
